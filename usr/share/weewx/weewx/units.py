...
obs_group_dict = ListOfDicts({
    ...
    "temp_garage"               : "group_temperature",
    "temp_dach"                 : "group_temperature",
    "temp_heizung_vorlauf"      : "group_temperature",
    "temp_heizung_ruecklauf"    : "group_temperature",
    "temp_sole_links"           : "group_temperature",
    "temp_sole_rechts"          : "group_temperature",
    "temp_boiler"               : "group_temperature",
    
    "wasser_schacht_pegel"      : "group_percent",
    "pv"                        : "group_power",
    "pv_day"                    : "group_energy",
    "pv_day_wh"                 : "group_energy",
    "pv_ost"                    : "group_power",
    "pv_sued"                   : "group_power",
    "pv_west"                   : "group_power",
    
    "netzbezug"                 : "group_power",
    "netzlieferung"             : "group_power",
    "eigenverbrauch"            : "group_power",

    "netzbezug_day"             : "group_energy",
    "netzlieferung_day"         : "group_energy",
    "eigenverbrauch_day"        : "group_energy",
    
    "netzbezug_day_c"           : "group_energy",
    "netzlieferung_day_c"       : "group_energy",
    "eigenverbrauch_day_c"      : "group_energy",
})
    ...
    def _to_string(self, val_t, context='current', addLabel=True,
        ...
        if val_t is None or val_t[0] is None:
            ...
            if localize:
                ...
                if format_string.find(",") >= 0:                                     # [!!!!]
#                    log.debug("[1] fs=" + format_string + " v=" + str(val_t[0]))     # [!!!!]
                    fs = format_string.replace(",","")                               # [!!!!]
#                    log.debug("[2] fs=" + fs + " v=" + str(val_t[0]))                # [!!!!]
                    val_str = locale.format_string(fs, val_t[0], grouping=True)      # [!!!!]
                else:                                                                # [!!!!]
