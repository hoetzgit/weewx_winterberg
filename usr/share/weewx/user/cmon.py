...
# [!!!!] Anpassungen durch This Manhart
    ...
    def get_data(self, now=None):
        ...
        try:
            ...
            if meminfo:
                ...
                record['mem_total'] = record['mem_total'] / 1048576                     # [!!!!] B => MB
                record['mem_free'] = record['mem_free'] / 1048576                       # [!!!!] B => MB
                record['mem_used'] = record['mem_used'] / 1048576                       # [!!!!] B => MB
        except Exception as e:
            logdbg("read failed for %s: %s" % (fn, e))
...
#            log.info("[1] total=" + str(total))
            free = free / 1048576                                                  # [!!!!] kB => GB
            total = total / 1048576                                                # [!!!!] kB => GB
            used = used / 1048576                                                  # [!!!!] kB => GB
#            log.info("[2] total=" + str(total))
