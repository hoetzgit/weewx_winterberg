...
table = [('dateTime',             'INTEGER NOT NULL UNIQUE PRIMARY KEY'),
         ...
         ('temp_dach','REAL'),
         ('temp_wohnen','REAL'),
         ('temp_heizung_vorlauf','REAL'),
         ('temp_heizung_ruecklauf','REAL'),
         ('temp_sole_links','REAL'),
         ('temp_sole_rechts','REAL'),
         ('temp_boiler','REAL'),
         
         ('wasser_schacht_pegel','REAL'),
         ...
         ('netzbezug_day_c','REAL'),
         ('netzbezug_day','REAL'),
         
         ('netzlieferung_day_c','REAL'),
         ('netzlieferung_day','REAL'),
         
         ('eigenverbrauch_day_c','REAL'),
         ('eigenverbrauch_day','REAL'),
